-- Shipping rules:
-- Italia: TNT 9,90 EUR, gratuita da 120 EUR
-- Estero: FedEx 22,90 EUR, sempre a pagamento
-- Ritiro in negozio: gratuito
--
-- Il metodo effettivo viene determinato dal Paese
-- dell'indirizzo lato database.
...
begin
  ...
  if v_effective_shipping_method = 'store_pickup' then
    ...
    and v_subtotal_gross_amount_minor >= 12000 then
    v_shipping_gross_amount_minor := 0;
